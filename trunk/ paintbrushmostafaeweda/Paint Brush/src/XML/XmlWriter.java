...
class XmlWriter {
     ...
     */
    public XmlWriter writeEntity(String name) throws WritingException, XmlWritingException {
        try {
            closeOpeningTag();
            this.closed = false;
            this.writer.write("<");
     ...
     * @throws XmlWritingException 
     */
    public XmlWriter writeAttribute(String attr, String value) throws WritingException, XmlWritingException {
     ...
     * @throws XmlWritingException 
     */
    public XmlWriter endEntity() throws WritingException, XmlWritingException {
        try {
            if(this.stack.empty()) {
     ...
     * @throws XmlWritingException 
     */
    public void close() throws WritingException, XmlWritingException {
        if(!this.stack.empty()) {
     ...
     * @throws XmlWritingException 
     */
    public XmlWriter writeText(String text) throws WritingException, XmlWritingException {
        try {
            closeOpeningTag();
            this.empty = false;
    ...
    static public void main(String[] args) throws WritingException, XmlWritingException {
        test1();
        test2();
    }
    static public void test1() throws WritingException, XmlWritingException {
    ...
    static public void test2() throws WritingException, XmlWritingException {
